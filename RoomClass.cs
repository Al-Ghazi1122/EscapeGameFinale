...
namespace EscapeGame
{
    ...
    public Room(string name, string description = "There is no description", string light = "on")
    {
        RoomName = name;
...
public kitchen(string name, string description, string light = "off", string sDoor = "open", string sDoor2= "closed", string 1Door = "locked")
{
    RoomName = name;
    RoomDescription = description;
    LightStatus = light;
